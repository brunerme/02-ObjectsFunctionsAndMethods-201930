...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    new_turt=rg.SimpleTurtle('turtle')
    new_turt.pen=rg.Pen('brown',5)
    new_turt.forward(150)
    new_turt.left(90)
    new_turt.forward(50)
    new_turt.backward(100)
...
def try_methods_and_functions():
    ...
    """
    last_turt=rg.SimpleTurtle('turtle')
    last_turt.pen=rg.Pen('blue',5)
    last_turt.backward(150)
    last_turt.speed=1
    draw_many_squares(last_turt,8,100, 60)
    last_turt.speed=5
    last_turt.pen=rg.Pen('red',5)
    draw_many_squares(last_turt,10,50,15)
    last_turt.speed=100
    last_turt.pen=rg.Pen('red',35)
    draw_many_squares(last_turt,8, 300, 60)
    last_turt.pen=rg.Pen('black',3)
    last_turt.backward(200)
    last_turt.draw_circle(30)
    last_turt.draw_square(50)
