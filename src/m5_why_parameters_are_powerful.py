...
def main():
    ...
    #even_better_draw_circles(rg.Point(0,100), 5, 15, 'red', 5)
    #even_better_draw_circles(rg.Point(100, 0), 10, 20, 'green',2)

    even_better_draw_circles(rg.Point(0,0), 10, 16, 'yellow',17)
    even_better_draw_circles(rg.Point(50, 50), 5, 4, 'black',10)
    even_better_draw_circles(rg.Point(-50, 50), 5, 4,'black',10)
    even_better_draw_circles(rg.Point(0,-73), 1, 1, 'black',25)
    even_better_draw_circles(rg.Point(10, -72),1,1,'black',25)
    even_better_draw_circles(rg.Point(20, -69),1,1,'black',25)
    even_better_draw_circles(rg.Point(30, -63), 1, 1, 'black', 25)
    even_better_draw_circles(rg.Point(40,-57),1,1,'black',25)
    even_better_draw_circles(rg.Point(-10,-72),1,1,'black',25)
    even_better_draw_circles(rg.Point(-20,-69),1,1,'black',25)
    even_better_draw_circles(rg.Point(-30, -63), 1, 1, 'black', 25)
    even_better_draw_circles(rg.Point(-40,-57),1,1,'black',25)
...
def better_draw_circles(point,radius_increment):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN GIVEN pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radius_increment)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radius_increment * k)
...
#
###############################################################################
def even_better_draw_circles(point,radius_increment, number, color, thickness):
    """
    Starts out the same as the   draw_circles   function defined ABOVE.
    You Will make it an IMPROVED, MORE POWERFUL function per the above _TODO_.
    """
